...
var test = new tinycolor({ r: 255, g: 0, b: 0 });
var test2 = test.toHexString();
console.log(test2);
...
port.onMessage.addListener(function(msg) {
	...
	if(msg.text == red || msg.text == blue)
	{
		...
		var color2 = tinycolor({ r: 255, g: 0, b: 134 });
		console.log(mytest.toHslString());
...
/*
*This is the tiny color code
*we were having problems with scope so we decided to past the code into
*changer.js
*NOTE!!!
*tinycolor is an open source library that we DID NOT make. We are using its
...
//consult the TINYCOLOR_LICENSE file for more details
